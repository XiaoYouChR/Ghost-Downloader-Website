...
<Cards>
  <Card title="在线构建" href="../github-actions" description="无法本地复现多平台环境时，使用 GitHub Actions。" />
  <Card title="仓库地图" href="../../getting-started/repository-map" description="查看 deploy.py、workflow 和扩展源码位置。" />
</Cards>
