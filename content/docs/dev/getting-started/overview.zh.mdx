...
<Cards>
  <Card title="把项目跑起来" href="../setup" description="安装 Python/Node 依赖，启动桌面端和扩展。" />
  <Card title="找源码入口" href="../repository-map" description="按任务类型定位核心文件。" />
  <Card title="看架构边界" href="../../architecture/overview" description="避免把逻辑写错层。" />
</Cards>
