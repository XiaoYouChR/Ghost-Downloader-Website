...
<Cards>
  <Card title="Run the Project" href="../setup" description="Install Python and Node dependencies, then start the desktop app and extension." />
  <Card title="Find the Right Source Files" href="../repository-map" description="Locate core files by task type." />
  <Card title="Understand Architecture Boundaries" href="../../architecture/overview" description="Avoid placing logic in the wrong layer." />
</Cards>
