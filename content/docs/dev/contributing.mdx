...
<Cards>
  ...
  <Card title="Contribute Translation" href="../translation" description="Open the Crowdin translation workspace and review the sync path." />
</Cards>
...
<Cards>
  <Card title="Local Build" href="../../workflows/local-build" description="Use python deploy.py to validate the desktop build." />
  <Card title="GitHub Actions" href="../../workflows/github-actions" description="Use the online workflows to build cross-platform artifacts." />
</Cards>
