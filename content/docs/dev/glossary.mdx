...
| Term | Meaning |
| --- | --- |
| TaskService | The background core service responsible for the AsyncIO event loop and task scheduling. |
...
| TaskStep | A sub-stage inside a task, used for chunks, sub-downloads, or processing phases. |
