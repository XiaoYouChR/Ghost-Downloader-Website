...
<Cards>
  <Card title="Online Build" href="../github-actions" description="Use GitHub Actions when you cannot reproduce a multi-platform environment locally." />
  <Card title="Repository Map" href="../../getting-started/repository-map" description="Find deploy.py, workflow files, and extension sources quickly." />
</Cards>
