...
| --- | --- | --- | --- |
| `http_pack` | HTTP / HTTPS files | `wreq`, Range, proxy support | `features/http_pack` |
...
| `m3u8_pack` | M3U8, MPD | `http_pack`, `disk_pack`, `ffmpeg_pack`, N_m3u8DL-RE | `features/m3u8_pack` |
...
| `ffmpeg_pack` | Runtime installation and media merging | `http_pack`, `disk_pack`, FFmpeg | `features/ffmpeg_pack` |
| `disk_pack` | Runtime extraction tasks | Local file system, archives | `features/disk_pack` |
