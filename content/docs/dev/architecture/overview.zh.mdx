...
<Cards>
  <Card title="任务系统" href="../task-system" description="任务状态、阶段、调度和持久化。" />
  <Card title="Feature Pack" href="../feature-pack-system" description="功能包发现、依赖排序和加载边界。" />
  <Card title="浏览器桥接" href="../browser-bridge" description="扩展如何连接桌面端并创建任务。" />
</Cards>
